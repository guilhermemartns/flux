...
// Componente separado para evitar re-renderização da animação inicial
const TimerContent = React.memo(({ 
  isMaximized, 
  time, 
  isRunning, 
  isPaused, 
  ...
  <motion.div
    key={`timer-${isMaximized ? 'maximized' : 'normal'}`} // Key para controlar quando animar
